...
class SelectMotherboard(caseNumber: Int, cpuNumber: Int, motherboardNumber: Int): SelectComponents {
    override val transferNumber: NavDirections = MotherboardSelectFragment3Directions.actionMotherboardSelectFragment3ToGpuSelectFragment43(caseNumber,caseNumber,motherboardNumber)
}
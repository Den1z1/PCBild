...
class CpuSelectFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        componentImage2.setImageResource(R.drawable.cpu_i3_10100f)
        SelectCpu(caseNumber,2).selectComponent(componentImage2,view)

        componentImage3.setImageResource(R.drawable.cpu_r5_3600)
        SelectCpu(caseNumber,3).selectComponent(componentImage3,view)

        componentImage4.setImageResource(R.drawable.cpu_i5_10400)
        SelectCpu(caseNumber,4).selectComponent(componentImage4,view)

        componentImage5.setImageResource(R.drawable.cpu_r5_5600)
